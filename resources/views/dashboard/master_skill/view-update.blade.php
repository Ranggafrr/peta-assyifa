    ...
    <form action="{{ route('master-skill.update', ['master_skill' => $data->id]) }}" method="post">
        ...
        <div class="flex justify-between mx-5 items-center">
            ...
            <div class="flex justify-end gap-x-2">
                <a href="{{ route('master-skill.index') }}" class="btn-outline-primary inline-flex items-center gap-x-2">
        ...
        <div class="grid grid-cols-4 gap-4 m-5 pb-4">
            <div class="w-full">
                <x-Input type="text" name="nama_skill" label="Nama Skill" :required="true" value="{{ old('nama_skill', $data->nama_skill) }}" />
            </div>
            <div class="w-full">
