...
<div class="mx-5 mt-3 border bg-white rounded-lg py-5">
    <form action="{{ route('data-rt.store') }}" method="post">
        ...
        <div class="grid grid-cols-4 gap-4 m-5 pb-4">
          <div class="w-full">
              <x-Input type="text" name="kode_rt" label="Kode Rt" :required="true" />
          </div>
          <div class="w-full">
              <x-Input type="text" name="nama_rt" label="Nama Rt" :required="true" />
          </div>
          <div class="w-full">
              <x-Input type="text" name="kode_rw" label=" Kode Rw" :required="false" />
          </div>
          <div class="w-full">
