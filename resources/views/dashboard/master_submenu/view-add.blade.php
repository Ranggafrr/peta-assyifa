    ...
    <div class="mx-5 mt-3 border bg-white rounded-lg py-5">
        <form action="{{ route('sub-menu.store') }}" method="post">
            ...
            <div class="grid grid-cols-4 gap-4 m-5 pb-4">
                ...
                <div class="w-full">
                    <x-Input type="text" name="nama_submenu" label="Nama sub menu" :required="true" />
                </div>
                <div class="w-full">
                    <x-Input type="number" name="no_urut" label="Nomor urut" :required="true" />
                </div>
                <div class="w-full">
                    <x-Input type="text" name="route" label="Nama rute" :required="true" />
                </div>
            </div>
        </form>
    </div>
