...
<div class="mx-5 mt-3 border bg-white rounded-lg py-5">
    <form action="{{ route('data-pendidikan.store') }}" method="post">
        @method('POST')
        @csrf
        ...
        <div class="grid grid-cols-4 gap-4 m-5 pb-4">
            ...
            <div class="w-full">
                <x-search-select name="tingkat_pendidikan" label="Tingkat Pendidikan" :options="['PAUD' => 'PAUD', 'SD' => 'SD', 'SMP/MTS' => 'SMP/MTS', 'SMA/SMK/MAN' => 'SMA/SMK/MAN', 'D3' => 'D3', 'D4/S1' => 'D4/S1', 'S2' => 'S2', 'S3' => 'S3']" placeholder="Pilih Tingkat Pendidikan" :hasSearch="false"
                    :required="true" />
            </div>
            <div class="w-full">
